...
(function () {
  ...
  function e(n) {
    ...
    if (n && n.length) {
      ...
      while ((o += 1) < f) {
        ...
        if (e <= 127) r += String.fromCharCode(e);
        else if (e <= 2047) {
  ...
  function D(n, e) {
    ...
    while (a.length > 0) {
      ...
      for (o = 0; o < a.length; o += 1) {
        ...
        f = Math.floor(i / t);
        i -= f * t;
        if (u.length > 0 || f > 0) u[u.length] = f;
      }
      r[r.length] = i;
      a = u;
    }
    c = "";
    for (o = r.length - 1; o >= 0; o--) c += e.charAt(r[o]);
    l = Math.ceil(n.length * 8 / (Math.log(e.length) / Math.log(2)));
    for (o = c.length; o < l; o += 1) c = e[0] + c;
    return c;
  }
  function B(n, e) {
    ...
    e = e || "=";
    for (f = 0; f < o; f += 3) {
      h = n.charCodeAt(f) << 16 | (f + 1 < o ? n.charCodeAt(f + 1) << 8 : 0) |
        (f + 2 < o ? n.charCodeAt(f + 2) : 0);
      for (i = 0; i < 4; i += 1) {
        if (f * 8 + i * 6 > n.length * 8) r += e;
        else r += t.charAt(h >>> 6 * (3 - i) & 63);
      }
    }
    return r;
  }
  n = {
    ...
    Base64: function () {
      ...
      this.encode = function (t) {
        ...
        t = f ? e(t) : t;
        for (o = 0; o < a; o += 3) {
          h = t.charCodeAt(o) << 16 | (o + 1 < a
            ? t.charCodeAt(o + 1) << 8
            : 0) |
            (o + 2 < a ? t.charCodeAt(o + 2) : 0);
          for (i = 0; i < 4; i += 1) {
            if (o * 8 + i * 6 > a * 8) u += r;
            else u += n.charAt(h >>> 6 * (3 - i) & 63);
          }
        }
        return u;
      };
      this.decode = function (e) {
        ...
        do {
          ...
          u = B & 255;
          C += 1;
          if (l === 64) s[C] = String.fromCharCode(i);
          else if (D === 64) s[C] = String.fromCharCode(i, h);
          else s[C] = String.fromCharCode(i, h, u);
        } while (o < e.length);
        A = s.join("");
        A = f ? t(A) : A;
        return A;
    ...
    MD5: function (n) {
      ...
      function l(n, t) {
        ...
        t = h ? e(t) : t;
        r = c(n);
        if (r.length > 16) r = C(r, n.length * 8);
    ...
    SHA1: function (n) {
      ...
      function C(n, e) {
        ...
        for (t = 0; t < n.length; t += 16) {
          ...
          for (f = 0; f < 80; f += 1) {
            if (f < 16) D[f] = n[t + f];
            else D[f] = o(D[f - 3] ^ D[f - 8] ^ D[f - 14] ^ D[f - 16], 1);
      ...
      function A(n, e, t, r) {
        if (n < 20) return e & t | ~e & r;
        if (n < 40) return e ^ t ^ r;
        if (n < 60) return e & t | e & r | t & r;
        return e ^ t ^ r;
      }
      function s(n) {
        return n < 20
    ...
    SHA256: function (n) {
      ...
      function c(n, t) {
        ...
        if (f.length > 16) f = m(f, n.length * 8);
        for (; o < 16; o += 1) {
          h[o] = f[o] ^ 909522486;
          a[o] = f[o] ^ 1549556828;
        }
      ...
      function m(n, e) {
        ...
        for (C = 0; C < n.length; C += 16) {
          ...
          for (A = 0; A < 64; A += 1) {
            if (A < 16) o[A] = n[A + C];
            else o[A] = r(r(r(g(o[A - 2]), o[A - 7]), d(o[A - 15])), o[A - 16]);
    ...
    SHA512: function (n) {
      ...
      function a(n, t) {
        ...
        if (i.length > 32) i = c(i, n.length * 8);
        for (; f < 32; f += 1) {
          h[f] = i[f] ^ 909522486;
          a[f] = i[f] ^ 1549556828;
        }
      ...
      function c(n, e) {
        ...
        for (r = 0; r < 80; r += 1) f[r] = new C(0, 0);
        n[e >> 5] |= 128 << 24 - (e & 31);
        n[(e + 128 >> 10 << 5) + 31] = e;
        o = n.length;
        for (r = 0; r < o; r += 32) {
      ...
      function d(n, e, t, r, o) {
        ...
        var i = (e.l >>> 16) + (t.l >>> 16) + (r.l >>> 16) + (o.l >>> 16) +
          (f >>> 16);
        var h = (e.h & 65535) + (t.h & 65535) + (r.h & 65535) + (o.h & 65535) +
          (i >>> 16);
        var u = (e.h >>> 16) + (t.h >>> 16) + (r.h >>> 16) + (o.h >>> 16) +
          (h >>> 16);
        n.l = f & 65535 | i << 16;
        n.h = h & 65535 | u << 16;
      }
      function g(n, e, t, r, o, f) {
        var i = (e.l & 65535) + (t.l & 65535) + (r.l & 65535) + (o.l & 65535) +
            (f.l & 65535),
          h = (e.l >>> 16) + (t.l >>> 16) + (r.l >>> 16) + (o.l >>> 16) +
            (f.l >>> 16) + (i >>> 16),
          u = (e.h & 65535) + (t.h & 65535) + (r.h & 65535) + (o.h & 65535) +
            (f.h & 65535) + (h >>> 16),
          a = (e.h >>> 16) + (t.h >>> 16) + (r.h >>> 16) + (o.h >>> 16) +
            (f.h >>> 16) + (u >>> 16);
        n.l = i & 65535 | h << 16;
        n.h = u & 65535 | a << 16;
      }
    ...
    RMD160: function (n) {
      ...
      function s(n, t) {
        ...
        if (f.length > 16) f = F(f, n.length * 8);
        for (r = 0; r < 16; r += 1) {
          i[r] = f[r] ^ 909522486;
          u[r] = f[r] ^ 1549556828;
        }
  ...
  (function (e, t) {
    ...
    if (typeof exports === "object") {
      r = exports;
      if (
        exports && typeof global === "object" && global &&
